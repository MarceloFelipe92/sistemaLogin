...
<div class="content">
  <div class="container mt-4">
    <h3 class="mb-4"><i class="fas fa-swimmer text-success"></i> Painel de Gerenciamento - Natação</h3>
    <p class="text-muted">Organize produtos como maiôs, toucas, óculos e acessórios para natação com facilidade.</p>
<hr>

    <div class="row g-3">
      <div class="col-md-4">
        <a href="cadastrar.php" class="btn btn-outline-success w-100 p-3 shadow-sm">
