...
<body style="background-color:rgba(179, 248, 225, 0.2);">
  ...
  <div class="content ">
    <div class="container mt-4">
      <h3 class="mb-4"><i class="fas fa-vr-cardboard text-danger"></i> Painel de Gerenciamento - RA</h3>
      <p class="text-muted">Gerencie os equipamentos, acessórios e suplementos voltados para RA e treino físico.</p>
      ...
      <div class="row g-3">
        <div class="col-md-4">
          <a href="<?php echo $_SESSION["url"]; ?>/RA/detalhe-produto.php" class="btn btn-outline-primary w-100 p-3 shadow-sm">
            <i class="fas fa-plus-circle me-2"></i>Cadastrar Produto
          </a>
        </div>
        <div class="col-md-4">
          <a href="<?php echo $_SESSION["url"]; ?>/RA/listar-produtos.php" class="btn btn-outline-secondary w-100 p-3 shadow-sm">
            <i class="fas fa-edit me-2"></i>Produtos Cadastrados
          </a>
        </div>
        <div class="col-md-4">
          <a href="<?php echo $_SESSION["url"]; ?>/RA/relatorio-vendas.php" class="btn btn-outline-success w-100 p-3 shadow-sm">
  ...
  <div class="content">
    <div class="container mt-4">
      ...
      <p class="text-muted">Visualize o desempenho dos produtos de RA com gráficos interativos.</p>
