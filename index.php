  ...
  <div class="container">
    ...
    <div class="row gy-4">
      ...
      <div class="category-card border-start border-primary border-2">
        <h4><i class="fas fa-users me-2 text-primary"></i>Clientes (<?php echo isset($_SESSION["clientes"]) ? count($_SESSION["clientes"]) : 0; ?>)</h4>
      ...
      <div class="category-card border-start border-success border-2">
        <h4><i class="fas fa-truck me-2 text-success"></i>Fornecedores (<?php echo isset($_SESSION["fornecedores"]) ? count($_SESSION["fornecedores"]) : 0; ?>)</h4>
        <p>Controle de todos os fornecedores no sistema.</p>
        <a href="<?php echo $_SESSION["url"]; ?>/fornecedores" class="btn btn-outline-success w-100 mb-2">
      ...
      <div class="category-card border-start border-warning border-2">
        <h4><i class="fas fa-shopping-cart me-2 text-warning"></i>Vendas (<?php echo isset($_SESSION["vendas"]) ? count($_SESSION["vendas"]) : 0; ?>)</h4>
    ...
    <div class="row mt-4">
      ...
      <div class="col-lg-6">
        <div class="card shadow-sm">
          <div class="card-header bg-white">
            <h5 class="mb-0"><i class="fas fa-exclamation-triangle text-warning me-2"></i>Alertas Importantes</h5>
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-6">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <div class="row g-2">
              <div class="col-md-6">
                <a href="<?php echo $_SESSION["url"]; ?>/produtos/adicionar" class="btn btn-outline-primary w-100 mb-2">
                  <i class="fas fa-plus-circle me-1"></i> Novo Produto
                </a>
              </div>
              <div class="col-md-6">
                <a href="<?php echo $_SESSION["url"]; ?>/vendas/nova" class="btn btn-outline-success w-100 mb-2">
                  <i class="fas fa-cash-register me-1"></i> Nova Venda
                </a>
              </div>
              <div class="col-md-6">
                <a href="<?php echo $_SESSION["url"]; ?>/clientes/adicionar" class="btn btn-outline-info w-100 mb-2">
                  <i class="fas fa-user-plus me-1"></i> Novo Cliente
                </a>
              </div>
              <div class="col-md-6">
                <a href="<?php echo $_SESSION["url"]; ?>/relatorios" class="btn btn-outline-secondary w-100 mb-2">
    ...
    <div class="card shadow-sm mt-5">
      ...
      <div class="card-body">
        ...
        <a href="<?php echo $_SESSION["url"]; ?>/vendas" class="btn btn-sm btn-outline-secondary mt-2">Ver todas as vendas</a>
      </div>
    </div>
    ...
    <div class="card shadow-sm mt-4">
      ...
      <div class="row">
        ...
        <a href="https://www.receita.fazenda.gov.br" target="_blank" class="btn btn-sm btn-outline-secondary w-100">
          <i class="fas fa-globe me-1"></i> Receita Federal
        </a>
        </div>
        <div class="col-6 mb-2">
        <a href="https://www.bcb.gov.br" target="_blank" class="btn btn-sm btn-outline-secondary w-100">
          <i class="fas fa-university me-1"></i> Banco Central
        </a>
        </div>
        <div class="col-6 mb-2">
        <a href="https://www.sebrae.com.br" target="_blank" class="btn btn-sm btn-outline-secondary w-100">
          <i class="fas fa-briefcase me-1"></i> Sebrae
        </a>
        </div>
        <div class="col-6 mb-2">
        <a href="https://www.inss.gov.br" target="_blank" class="btn btn-sm btn-outline-secondary w-100">
