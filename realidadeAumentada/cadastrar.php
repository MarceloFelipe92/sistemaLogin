...
<head>
  <meta charset="UTF-8">
  <title>Cadastrar Produto - Realidade Aumentada</title>
...
<div class="form-container mt-5" >
  <div class="card shadow-lg p-4">
    <h2 class="mb-4 text-dark"><i class="fas fa-vr-cardboard me-2"></i>Cadastrar Produto de Realidade Aumentada</h2>
<hr>
